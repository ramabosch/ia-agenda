...
class ParserBehaviorTests(unittest.TestCase):
    ...
    def test_parse_creation_queries(self):
        ...
        create_future_week = parse_user_query("crea una tarea para revisar indicadores para dentro de una semana")
        create_future_range = parse_user_query("crea una tarea para la semana que viene")
        ...
        self.assertEqual(create_future_week["due_hint"], "dentro de una semana")
        self.assertEqual(create_future_week["time_scope"], "relative_weeks")
        self.assertEqual(create_future_range["due_hint"], "la semana que viene")
        self.assertEqual(create_future_range["time_scope"], "next_week")
    ...
    def test_parse_agenda_queries(self):
        ...
        create_event_future = parse_user_query("agendá una reunion con alimentos para dentro de una semana a las 17:00")
        create_event_relative_days = parse_user_query("agendá una llamada con Cam en 10 dias a las 11")
        create_reminder = parse_user_query("recordame manana revisar indicadores")
        create_reminder_future = parse_user_query("recordame dentro de dos semanas revisar indicadores")
        ...
        next_days = parse_user_query("que tengo en los proximos dias")
        next_week = parse_user_query("que tengo la semana que viene")
        in_two_weeks = parse_user_query("que tengo dentro de dos semanas")
        future_horizon = parse_user_query("que se viene")
        ...
        self.assertEqual(create_event_future["agenda_date_hint"], "dentro de una semana")
        self.assertEqual(create_event_future["agenda_time_hint"], "17:00")
        self.assertEqual(create_event_future["agenda_title"], "reunion con alimentos")
        self.assertEqual(create_event_relative_days["agenda_date_hint"], "en 10 dias")
        self.assertEqual(create_event_relative_days["agenda_time_hint"], "11")
        self.assertEqual(create_event_relative_days["agenda_title"], "llamada con cam")
        self.assertEqual(create_reminder["agenda_kind"], "reminder")
        self.assertEqual(create_reminder["agenda_date_hint"], "manana")
        self.assertEqual(create_reminder_future["agenda_date_hint"], "dentro de dos semanas")
        ...
        self.assertEqual(next_days["agenda_query_scope"], "next_days")
        self.assertEqual(next_week["agenda_query_scope"], "next_week")
        self.assertEqual(in_two_weeks["agenda_query_scope"], "future_target")
        self.assertEqual(in_two_weeks["agenda_date_hint"], "dentro de dos semanas")
        self.assertEqual(future_horizon["agenda_query_scope"], "future_horizon")
